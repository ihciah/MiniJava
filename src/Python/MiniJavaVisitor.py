...
class MiniJavaVisitor(ParseTreeVisitor):
    ...
    def visitMainClassBody(self, ctx):
        return self.visitChildren(ctx)
    ...
    def visitMainMethodDeclaration(self, ctx):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MiniJavaParser#mytype.
    def visitMytype(self, ctx):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniJavaParser#nestedStatement.
    def visitNestedStatement(self, ctx):
        return self.visitChildren(ctx)
    ...
    def visitArrayAssignStatement(self, ctx):
        return self.visitChildren(ctx)
    ...
    def visitIntLitExpression(self, ctx):
        return self.visitChildren(ctx)
    ...
    def visitArrayAccessExpression(self, ctx):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniJavaParser#addExpression.
    def visitAddExpression(self, ctx):
        return self.visitChildren(ctx)
    ...
    def visitArrayLengthExpression(self, ctx):
        return self.visitChildren(ctx)
    ...
    def visitMethodArgumentList(self, ctx):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MiniJavaParser#intArrayType.
    def visitIntArrayType(self, ctx):
        return self.visitChildren(ctx)
